...
pub type cmpfun_ptr = ::std::option::Option<
    unsafe extern "C" fn(
...
pub type tristate = ::std::os::raw::c_int;
extern "C" {
    pub fn panic(fmt: *const ::std::os::raw::c_char, ...);
}
extern "C" {
    pub fn not_reached(file: *const ::std::os::raw::c_char, line: ::std::os::raw::c_int);
}
extern "C" {
    pub fn not_implemented(file: *const ::std::os::raw::c_char, line: ::std::os::raw::c_int);
}
extern "C" {
